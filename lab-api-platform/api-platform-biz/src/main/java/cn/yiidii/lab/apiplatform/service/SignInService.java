package cn.yiidii.lab.apiplatform.service;
...
import cn.yiidii.lab.apiplatform.model.body.MiBrushStepBody;
import cn.yiidii.lab.apiplatform.model.dto.DingDongSignInResponseDTO;
import cn.yiidii.lab.apiplatform.model.dto.EverPhotoSignInResponseDTO;
import cn.yiidii.lab.apiplatform.model.dto.TencentVideoSignInResponseDTO;
...
public class SignInService {
    ...
    public R<String> iios(String email, String password) {
        ...
        try {
            ...
            // 调用python签到
            File iiosPy = LabFileUtil.getVarFileFromClassPath("/src/main/resources/script/iios.py", false);
